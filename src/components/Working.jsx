  ...
  return (
    <>
      ...
      <div className="container">
        ...
        <h2 className="section-title mb-5">Study Periode</h2>

        <div className="row py-3 border-bottom">
          <div className="col md-4">September 2022 - Today</div>
          <div className="col md-4">Information System - Student</div>
          <div className="col md-4">Politeknik of Padang</div>
        </div>

        <div className="row py-3 border-bottom">
          <div className="col md-4">2019 - 2022</div>
          <div className="col md-4">Science - Student</div>
          <div className="col md-4">SMAN 4 MANDAU</div>
        </div>

        <div className="row py-3 border-bottom">
          <div className="col md-4">2016 - 2019</div>
          <div className="col md-4">General - Student</div>
          <div className="col md-4">SMPN 1 MANDAU</div>
        </div>
      </div>
    </section>
